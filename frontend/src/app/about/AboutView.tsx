      ...
      <div className="container-wide py-8 sm:py-10">
        ...
        <div className="relative mb-6 mt-6 sm:mt-8">
          ...
          <div className="relative">
            <div className="max-w-3xl mb-6 sm:mb-8">
              <div className="inline-block px-3.5 py-1 bg-[#2C1810] text-white text-[9px] font-bold tracking-widest mb-4 sm:mb-6 rounded-full">{t('Kustomisasi', 'Customization')}</div>
              <h2 className="text-2xl sm:text-5xl font-bold text-[#2C1810] tracking-tight mb-4 sm:mb-6 leading-[1.15]">{t('Layanan Kustomisasi Premium', 'Premium Customization Services')}</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
              <div className="lg:col-span-5">
                <div className="relative rounded-xl bg-[#2C1810] min-h-[340px] sm:min-h-[500px]">
              ...
              <div className="lg:col-span-7 grid grid-cols-2 gap-3 sm:gap-6">
                <div className="bg-white border-2 border-neutral-200 rounded-xl p-3 sm:p-6 hover:border-[#2C1810] transition-all">
                  <h3 className="font-bold text-[#2C1810] text-[11px] sm:text-lg mb-1 sm:mb-3">{t('Dimensi', 'Dimensions')}</h3>
                ...
                <div className="bg-white border-2 border-neutral-200 rounded-xl p-3 sm:p-6 hover:border-[#2C1810] transition-all">
                  <h3 className="font-bold text-[#2C1810] text-[11px] sm:text-lg mb-1 sm:mb-3">{t('Bentuk', 'Shape & Form')}</h3>
                ...
                <div className="bg-white border-2 border-neutral-200 rounded-xl p-3 sm:p-6 hover:border-[#2C1810] transition-all">
                  <h3 className="font-bold text-[#2C1810] text-[11px] sm:text-lg mb-1 sm:mb-3">{t('Warna', 'Color Palette')}</h3>
                ...
                <div className="bg-white border-2 border-neutral-200 rounded-xl p-3 sm:p-6 hover:border-[#2C1810] transition-all">
                  <h3 className="font-bold text-[#2C1810] text-[11px] sm:text-lg mb-1 sm:mb-3">{t('Material', 'Materials')}</h3>
                ...
                <div className="bg-white border-2 border-neutral-200 rounded-xl p-3 sm:p-6 hover:border-[#2C1810] transition-all col-span-2">
                  <h3 className="font-bold text-[#2C1810] text-[11px] sm:text-lg mb-1 sm:mb-3">{t('Fungsi', 'Functionality')}</h3>
