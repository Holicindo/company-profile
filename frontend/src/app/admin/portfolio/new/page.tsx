  ...
  return (
    <div className="max-w-4xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#2C1810]">Tambah Portfolio Baru</h1>
          <p className="text-sm text-[#2C1810]/60">Tambahkan proyek ke halaman portfolio</p>
        </div>
      </div>
            ...
            <div className="bg-gradient-to-br from-[#FAF7F0] to-[#F5F1E8] rounded-2xl border-2 border-[#2C1810] p-5 space-y-4 shadow-xl">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 border-2 border-[#2C1810]/20 rounded-xl text-[#2C1810] bg-white focus:outline-none focus:ring-2 focus:ring-[#B8941E]/50 focus:border-[#B8941E]/50 transition"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2.5 border-2 border-[#2C1810]/20 rounded-xl text-[#2C1810] bg-white focus:outline-none focus:ring-2 focus:ring-[#B8941E]/50 focus:border-[#B8941E]/50 transition resize-y"
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-br from-[#FAF7F0] to-[#F5F1E8] rounded-2xl border-2 border-[#2C1810] p-5 space-y-4 shadow-xl">
              ...
              <div>
                ...
                <input type="text" value={form.clientName} onChange={e => set('clientName', e.target.value)} placeholder="PT. Nama Klien" className="w-full px-3 py-2.5 border-2 border-[#2C1810]/20 rounded-xl text-[#2C1810] bg-white focus:outline-none focus:ring-2 focus:ring-[#B8941E]/50 focus:border-[#B8941E]/50 transition" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-[#2C1810] mb-1.5">Tanggal Proyek</label>
                <input type="text" value={form.projectDate} onChange={e => set('projectDate', e.target.value)} placeholder="Contoh: 2024-03 atau Maret 2024" className="w-full px-3 py-2.5 border-2 border-[#2C1810]/20 rounded-xl text-[#2C1810] bg-white focus:outline-none focus:ring-2 focus:ring-[#B8941E]/50 focus:border-[#B8941E]/50 transition" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-[#2C1810] mb-1.5">Lokasi</label>
                <input type="text" value={form.location} onChange={e => set('location', e.target.value)} placeholder="Contoh: Jakarta, Indonesia" className="w-full px-3 py-2.5 border-2 border-[#2C1810]/20 rounded-xl text-[#2C1810] bg-white focus:outline-none focus:ring-2 focus:ring-[#B8941E]/50 focus:border-[#B8941E]/50 transition" />
              </div>
