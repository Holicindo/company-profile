    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mb-6 pb-5 border-b-2 border-[#2C1810]/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[#2C1810]">Tambah Portfolio Baru</h1>
            <p className="text-sm text-[#2C1810]/50 mt-0.5">Tambahkan proyek ke halaman portfolio</p>
          </div>
        </div>
      ...
      <form id="new-portfolio-form" onSubmit={handleSubmit}>
