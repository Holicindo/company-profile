...
export function Footer() {
  ...
  return (
    <footer className="bg-dark-metallic relative overflow-hidden flex flex-col">
      ...
      <div className="py-10 sm:py-14 md:py-16 relative border-b border-white/5">
        <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, white 1px, transparent 0)', backgroundSize: '40px 40px' }} />
        <div className="container-wide relative z-10">
          <div className="max-w-4xl mx-auto text-center px-2 flex flex-col items-center">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-light tracking-wide text-white mb-3 sm:mb-4 pb-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center w-full sm:w-auto">
              ...
              <a 
                ...
                className="group flex items-center justify-center gap-2 px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-white rounded-full transition-all duration-300 bg-[#128C7E]/25 hover:bg-[#128C7E] shadow-sm border border-[#128C7E]/80 active:scale-[0.98] w-full sm:w-auto"
              >
              ...
              <a 
                ...
                className="group flex items-center justify-center gap-2 px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-white rounded-full transition-all duration-300 bg-[#1976D2]/25 hover:bg-[#1976D2] shadow-sm border border-[#1976D2]/80 active:scale-[0.98] w-full sm:w-auto"
              >
