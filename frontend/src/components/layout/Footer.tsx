...
export function Footer() {
  ...
  return (
    <footer className="bg-[#404F68] relative overflow-hidden flex flex-col">
      ...
      <div className="py-12 md:py-16 relative">
        ...
        <div className="container-wide relative z-10">
          <div className="max-w-4xl mx-auto text-center px-2 flex flex-col items-center">
            ...
            <p className="text-neutral-200 font-normal text-base md:text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
              {t(
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center w-full sm:w-auto">
              ...
              <a 
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 text-[10px] font-bold uppercase tracking-widest text-white rounded-lg transition-all duration-300 hover:brightness-110 hover:shadow-lg shadow-sm border border-white/20"
              ...
              >
                <Mail size={16} strokeWidth={2.5} className="flex-shrink-0" />
                Email Kami
              </a>
            </div>
          </div>
      ...
      <div className="container-wide py-8 md:py-10 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div>
            ...
            >
              Lihat di Maps <ExternalLink size={12} strokeWidth={2} />
            </a>
          </div>
              ...
              {socialLinks.map(s => {
                ...
                return (
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:shadow-lg rounded-md"
      ...
      <div className="border-t border-white/10 relative z-10">
        <div className="container-wide py-4 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-[9px] font-bold uppercase tracking-widest text-neutral-300">© {new Date().getFullYear()} Holicindo. All rights reserved.</p>
          <p className="text-[9px] font-bold uppercase tracking-widest text-neutral-300">Food Machinery, Refrigerator &amp; Showcase</p>
        </div>
      </div>
    </footer>
  );
