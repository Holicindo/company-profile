    ...
    <section className="py-28 bg-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 container-wide">
        <div className="text-center mb-14">
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-brand-400 uppercase mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 hover:bg-slate-800 transition-colors shadow-lg">
      ...
      {/* Wavy Divider BAWAH — dari slate-900 ke white (ProjectsSection) */}
