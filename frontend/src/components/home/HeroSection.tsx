  ...
  return (
    <>
      <section className="relative bg-[#0d1013] min-h-[95vh] flex items-center pt-24 pb-32 overflow-hidden">
        ...
        {/* ── LAYER 10 — Gambar mesin ── */}
        {/* Inilah yang menciptakan efek depth 3D: HOLIC tertutup sebagian gambar */}
        <div className="absolute inset-0 pointer-events-none hidden md:block" style={{ zIndex: 10 }}>
          ...
          <div className="relative w-full h-full">
            ...
            />
            {/* Fade kiri agresif — tutup mesin background di sisi kiri, hanya showcase utama yang muncul */}
            <div
              className="absolute inset-0"
              style={{
                background: 'linear-gradient(to right, #0d1013 0%, #0d1013 42%, rgba(13,16,19,0.95) 52%, rgba(13,16,19,0.75) 60%, rgba(13,16,19,0.3) 70%, transparent 82%)',
                zIndex: 2,
              }}
            />
            {/* Fade bawah */}
        ...
        {/* ── LAYER 20 — Konten teks utama (paling depan) ── */}
        <div className="relative container-wide flex flex-col justify-center h-full" style={{ zIndex: 20 }}>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">

            {/* Left Column — teks float langsung tanpa card */}
            <div className="lg:col-span-6 xl:col-span-5 relative -ml-2 lg:-ml-4" style={{ zIndex: 30 }}>
              <h1 className="text-5xl md:text-6xl lg:text-[4.2rem] font-extrabold tracking-tight text-white leading-[1.08] mb-5">
                Distributor Resmi<br />
                <span className="text-neutral-400">Mesin Food &amp; Beverage<br />Indonesia</span>
              </h1>
              <p className="text-base md:text-lg text-neutral-400 font-medium leading-relaxed mb-8 max-w-md">
        ...
        {/* Wavy Divider at bottom with negative margin to fix sub-pixel gap line */}
