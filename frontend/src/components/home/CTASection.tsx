    ...
    <section className="py-16 md:py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 container-wide">
        <div className="max-w-3xl mx-auto text-center px-2">
          ...
          <p className="text-neutral-400 text-sm md:text-lg mb-8 md:mb-10 max-w-md mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/6281111825718" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 text-neutral-400 hover:text-white transition-colors">
              <svg viewBox="0 0 24 24" fill="currentColor" className="text-brand-400 w-4 h-4 flex-shrink-0">
            ...
            <a href="mailto:info@holicindo.com" className="flex items-center justify-center gap-2 text-neutral-400 hover:text-white transition-colors">
